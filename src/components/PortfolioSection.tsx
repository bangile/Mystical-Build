      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <div className="w-16 h-1 bg-[#d4af37] mt-4 mb-3 rounded-full" />
            <p className="text-[#4d4635] text-base max-w-xl">
        ...
        <div className="flex flex-wrap gap-2 sm:gap-3 mb-10 pb-2 border-b border-stone-100">
          {filterTabs.map((tab) => (
            <button
              key={tab.id}
